...
| File                        | Purpose                                                                            |
| --------------------------- | ---------------------------------------------------------------------------------- |
| `{project}/02-outline.md`   | The structural outline to review                                                   |
...
**IMPORTANT:** Read the audience profile in `00-request.md` first. Every review decision is calibrated to the declared audience, not your own expertise.
...
- **MUST:** Sections outside scope, missing in-scope content, structural problems that would prevent the reader from completing tasks (prerequisites after procedures, critical content missing)
- **SHOULD:** Sections with no research backing, ignored research findings, structural weaknesses that don't block but hinder navigation, depth mismatches with audience, missing progressive disclosure plans
...
- **PASS:** Zero MUST items. SHOULD and MINOR items exist but the outline provides a sound structural plan. The Tech Writer can proceed to drafting.
- **MUST-REVISE:** One or more MUST items. The outline has structural problems that must be fixed before drafting begins.
...
**CONDITIONAL-PASS guidelines:** Use when you have 5+ SHOULD items and they collectively indicate a pattern (all relate to audience mismatch, or all relate to structural flow problems) rather than being isolated nitpicks.
...
Good: Flagging sections that lack "Covers," "Key points," "Research notes," or "Progressive disclosure" fields
...
- Classifies severity correctly (structural violation that blocks readers)
- Cites the specific style guide rule
- Explains reader impact (readers will reach deployment steps unprepared)
- Provides concrete, actionable fix
- References the specific location in the outline
